...
bool gen_helper(const JavaName &jn, const char *repoid, bool narrow = false)
{
  ...
  if (narrow) {
    body +=
      ...
      + " narrow(idl2jni.corba.org.omg.CORBA.Object obj) {\n"
      "    if (obj == null)\n"
      "      return null;\n"
      "    else if (obj instanceof " + jn.clazz_ + ")\n"
      "      return (" + jn.clazz_ + ")obj;\n"
      "    else if (!obj._is_a (id ()))\n"
      "      throw new idl2jni.corba.org.omg.CORBA.BAD_PARAM ();\n"
      "    else\n"
      "      return native_unarrow(obj);\n"
      "  }\n\n"
      "  public static " +  jn.clazz_
      + " unchecked_narrow(idl2jni.corba.org.omg.CORBA.Object obj) {\n"
      "    if (obj == null)\n"
      "      return null;\n"
      "    else if (obj instanceof " + jn.clazz_ + ")\n"
      "      return (" + jn.clazz_ + ")obj;\n"
      ...
      + " native_unarrow(idl2jni.corba.org.omg.CORBA.Object obj);\n";
  }
...
std::string param_type(AST_Type *t, AST_Argument::Direction dir)
{
  ...
  if (builtin) type = "idl2jni.corba.org.omg.CORBA." + type;
                                  ...
                                  const std::vector<AST_Operation *> &ops, const char *repoid)
{
  ...
  string extends = jn.clazz_ + "Operations, "
                   + (inherits.size() ? "" : "idl2jni.corba.org.omg.CORBA.Object");
  string extends_ops;
  ...
  if (local) {
    ...
    ok = java_class_gen(jn_lb, JABSTRACT_CLASS, lb.c_str(),
                        "idl2jni.corba.org.omg.CORBA.LocalObject", jn.clazz_.c_str());
  }
                                 ...
                                 const AST_Union::DefaultValue &default_value, const char *repoid)
{
  ...
  for (size_t i = 0; i < branches.size(); ++i) {
    ...
    body_branches +=
      "  private " + ty + ' ' + brname + ";\n\n"
      "  public " + ty + ' ' + brname + "() {\n"
      "    if (" + disc_check + ") throw new idl2jni.corba.org.omg.CORBA.BAD_OPERATION();\n"
      "    return " + brname + ";\n"
      "  }\n\n"
    ...
    if (n_labels > 1 || default_disc_check.size() > 0) {
      body_branches +=
        ...
        "idl2jni.corba.org.omg.CORBA.BAD_PARAM(34, "
        "idl2jni.corba.org.omg.CORBA.CompletionStatus.COMPLETED_MAYBE);\n"
