package HelloWorld;
public class _MessageDataWriterTAOPeer extends idl2jni.runtime.i2jrt.TAOLocalObject implements MessageDataWriter {
  protected _MessageDataWriterTAOPeer(long ptr) {
    super(ptr);
  }

  public native int register_instance(HelloWorld.Message instance);

  public native int register_instance_w_timestamp(HelloWorld.Message instance, DDS.Time_t timestamp);

  public native int unregister_instance(HelloWorld.Message instance, int handle);

  public native int unregister_instance_w_timestamp(HelloWorld.Message instance, int handle, DDS.Time_t timestamp);

  public native int write(HelloWorld.Message instance_data, int handle);

  public native int write_w_timestamp(HelloWorld.Message instance_data, int handle, DDS.Time_t source_timestamp);

  public native int dispose(HelloWorld.Message instance_data, int instance_handle);

  public native int dispose_w_timestamp(HelloWorld.Message instance_data, int instance_handle, DDS.Time_t source_timestamp);
